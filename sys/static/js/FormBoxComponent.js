...
Vue.component('form-box-comm', {
 ...
 <div v-if="isShow || formType>0" :class="formClass">
    ...
    <!--<el-form :model="model" ref="ruleForm" style="width:100%"> -->
        <slot>
...
`,
    ...
    methods: {
        ...
        doSaveOrUpdate() {
            //决定走新增还是修改
            if ((this.idKey == null || this.idKey == "") && this.addApiUrl != null) {
                console.log("add===>", this.model);
                this.add();
            } else if (this.idKey != null && this.idKey != "" && this.editApiUrl != null) {
