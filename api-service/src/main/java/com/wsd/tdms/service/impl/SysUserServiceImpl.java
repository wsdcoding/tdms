...
import com.wsd.tdms.components.BCryptPasswordEncoderUtil;
import com.wsd.tdms.dao.SysRoleTableDao;
import com.wsd.tdms.dao.SysUserMapper;
import com.wsd.tdms.entity.Organization;
import com.wsd.tdms.entity.SysRoleTable;
import com.wsd.tdms.entity.SysUserTable;
import com.wsd.tdms.service.OrganizationService;
import com.wsd.tdms.service.SysRoleUserTableService;
import com.wsd.tdms.service.SysUserService;
import com.wsd.tdms.service.auth.AuthUser;
import com.wsd.tdms.service.auth.AuthUserDetailsServiceImpl;
import com.wsd.tdms.vo.SysUserVo;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUserTable> implements SysUserService {
    ...
    public IPage<SysUserVo> getUserVoList(final IPage<SysUserTable> page, final SysUserTable sysUserTable) {
       ...
       // IPage<SysUserTable> page1 = new Page<SysUserTable>();
