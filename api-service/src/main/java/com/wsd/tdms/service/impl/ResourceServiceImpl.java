...
import com.wsd.tdms.dao.ResourceDao;
import com.wsd.tdms.entity.Resource;
import com.wsd.tdms.service.ResourceService;
...
public class ResourceServiceImpl extends ServiceImpl<ResourceDao, Resource> implements ResourceService {
    ...
    public IPage<ResourceVo> getResourceVoList(final IPage<ResourceVo> page,final ResourceVo resourceVo,boolean isPublic) {
       ...
       log.info("resourceVo====="+resourceVo); 
        ...
        //user_show
       // queryWrapper.apply("a.type_id = b.id AND c.id = b.organization_id AND d.organization_id = c.id","");
